...
const showThePrice = (price :number | string) :void => {
   let formatedPrice;
...
// you can use unions with type keyword to create a unique type that can receive diferent values, look below
type houseType = 'house' | 'apartament' | 'studio';